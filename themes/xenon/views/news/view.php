        ...
        <div class="row">
            ...
            <div class="col-md-3">
                ...
                <div class="side-panel related">
                    <h2 class="side-title">Related News</h2>
                ...
                <div class="side-panel"><?= \app\widgets\NewsTaglist::widget(['news' => $model]) ?></div>

                <div class="side-panel"> <?= \app\widgets\NewsArchive::widget() ?></div>
