        ...
        <div class="row">
            <div class="col-md-12">
                <div class="heading-separator">
                    <h2 class="text-center"><span>Current Developer Team</span></h2>
                </div>
                    ...
                    <div class="row">
                        <?php foreach ($row as $i => $member): ?>
                            <div class="col-xs-4 col-sm-4 col-md-2 person-card <?= ($i == 0 && count($row) < 6) ? 'col-md-offset-' . (6 - count($row)) : '' ?>">
                                <div class="avatar">
                                    <img src="<?= Html::encode(Yii::getAlias($member['photo'])) ?>"
                ...
                <div class="heading-separator">
                    <h2 class="text-center">Inactive Team Members</h2>
                    <hr>
                </div>
                ...
                <div class="heading-separator">
                    <h2 class="text-center"><span>Past Team Members</span></h2>
                    <hr>
                </div>
                ...
                <p>
                    There is a huge community of <a
                            href="https://github.com/yiisoft/yii2/graphs/contributors">contributors</a> working on the
                    Yii
                    Framework code.
                    Without their help it would not be possible to provide and maintain the huge amount of
                    functionality,
                ...
                <?php if ($contributors === false): ?>
                    <div class="alert alert-warning">
                        <p>
                            Github.com seems to be unavailable. Thus we curently can not show the list of contributors
                            here.
                ...
                <?php else: ?>
                    <p>
                        The following list shows all the people who have contributed to the <a
                                href="https://github.com/yiisoft/yii2">yiisoft/yii2</a> repository on Github.
                        If you are one of them, thank you! If
                        not, <?= Html::a('become a part of it', ['site/contribute']) ?>!
                    </p>
