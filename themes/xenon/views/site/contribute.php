        ...
        <div class="content">
            <div class="row">
                <div class="col-md-12">
                    ...
                    <p class="text-center"><img class="icon"
                                                src="<?= Yii::getAlias('@web/image/contribute/ico_contribute_01.svg') ?>"
                                                alt=""></p>
                    <p class="text-center">You like Yii? Built an outstanding website or application? Blog about it,
                        tweet about it,
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            ...
                            <p class="text-center"><img class="icon"
                                                        src="<?= Yii::getAlias('@web/image/contribute/ico_contribute_02.svg') ?>"
                                                        alt=""></p>
                            <p>
                            ...
                            <p>
                                Please use the <?= Html::a('contact form', ['site/security']) ?> to report any security
                                issues.
                            ...
                            <ul>
                                ...
                                <li>If you're not sure if it's a bug or not,
                                    <a href="http://www.yiiframework.com/forum/index.php?/forum/11-bug-discussions/">discuss
                                        it at the forum</a> first.
                                </li>
                            </ul>
                        </div>
                        <div class="col-md-6">
                            ...
                            <p class="text-center"><img class="icon"
                                                        src="<?= Yii::getAlias('@web/image/contribute/ico_contribute_03.svg') ?>"
                                                        alt=""></p>
                    ...
                    <div class="row">
                        <div class="col-md-4">
                            ...
                            <p class="text-center"><img class="icon"
                                                        src="<?= Yii::getAlias('@web/image/contribute/ico_contribute_04.svg') ?>"
                                                        alt=""></p>
                        ...
                        <div class="col-md-4">
                            ...
                            <p class="text-center"><img class="icon"
                                                        src="<?= Yii::getAlias('@web/image/contribute/ico_contribute_05.svg') ?>"
                                                        alt=""></p>
                        ...
                        <div class="col-md-4">
                            ...
                            <p class="text-center"><img class="icon"
                                                        src="<?= Yii::getAlias('@web/image/contribute/ico_contribute_06.svg') ?>"
                                                        alt=""></p>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            ...
                            <p class="text-center"><img class="icon"
                                                        src="<?= Yii::getAlias('@web/image/contribute/ico_contribute_07.svg') ?>"
                                                        alt=""></p>
                            ...
                            <p>Also each page in the <?= Html::a('Definitive Guide', ['guide/entry']) ?> has an edit
                                link
                                on the bottom, that lets you update the file and submit your changes directly via
                                Github.</p>
                        </div>
                        <div class="col-md-6">
                            <div class="heading-separator">
                            ...
                            <p class="text-center"><img class="icon"
                                                        src="<?= Yii::getAlias('@web/image/contribute/ico_contribute_08.svg') ?>"
                                                        alt=""></p>
                            ...
                            <p>Instructions on how to do the translation work are given in
                                the
                                <a href="https://github.com/yiisoft/yii2/blob/master/docs/internals/translation-workflow.md">Translation
                                    workflow</a> at GitHub.
