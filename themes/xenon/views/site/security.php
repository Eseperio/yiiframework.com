    ...
    <div class="box bottom-space">
        <div class="content">
            <div class="row">
                <div class="col-md-12">
                    ...
                    <?php else: ?>
                        <p>Please use the security issue form to report to us any security issue
                            you find in Yii. DO NOT use the issue tracker or discuss it in the public forum as it will
                            cause more damage
                            than help.</p>
                    <?php endif ?>
                ...
                <div class="col-md-3">
                    <p class="small">Once we receive your issue report, we will treat it as our highest priority. We
                        will generally take the
                        following steps in responding to security issues.</p>

                    <ol class="issue-process">
                        <li>Confirm the issue. We may contact with you for further discussion. We will send you an
                            acknowledgement
